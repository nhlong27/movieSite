...
import { themeAtom } from '@/components/Layout'
    ...
    <>
      ...
      <Media lessThan="md">
        <nav className="grid grid-cols-5 w-11/12 min-w-[300px] ">
          ...
          <div
            className={`h-1/2 rounded-lg my-auto w-full whitespace-nowrap flex items-center col-span-1 justify-center bg-stone-300 dark:bg-stone-700 gap-4 z-10 ${
