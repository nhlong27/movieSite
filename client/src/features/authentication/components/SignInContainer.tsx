  ...
  return (
    <div className='w-full h-full p-4 flex flex-col justify-start items-center font-poppins bg-transparent'>
      ...
      <div className=' flex justify-center items-center w-5/6 px-4 mt-10 gap-4 font-bold text-center text-base md:text-lg text-stone-900 bg-yellow-500 py-4 rounded-xl'>
        <h2>Not a member?</h2>
        <ButtonComponent className='font-black leading-6 text-orange-700 hover:text-orange-600 text-lg xs:text-xl' onClick={() => setShouldSignInDisplay(false)}>
          Create a new account
        </ButtonComponent>
      </div>
      <Link to='/' className='mt-8 text-white text-base xs:text-xl hover:underline  mb-16'>Or back to home page</Link>
    </div>
  );
};
