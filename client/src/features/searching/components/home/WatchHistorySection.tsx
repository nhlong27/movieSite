...
const WatchHistorySection = () => {
  ...
  return historyList ? (
    ...
    <div className='h-[5rem] w-full group flex justify-center items-center bg-stone-300 border-y-2 border-stone-400 font-poppins text-normal font-bold text-stone-800 px-8 dark:bg-gradient-to-r dark:from-stone-900 dark:via-stone-800 dark:to-stone-900 dark:border-yellow-600 dark:text-yellow-500 shadow-sm dark:shadow-yellow-400'>
      ...
      <Link
        className='ml-8 group-hover:ml-0 overflow-hidden group-hover:max-w-[10rem] opacity-0 group-hover:opacity-100 transition-all duration-300 grid place-items-center px-4 py-2 rounded-lg bg-stone-600 text-stone-50 shadow-lg dark:hover:bg-yellow-600 dark:bg-yellow-500 dark:text-stone-900 whitespace-nowrap'
        to='/profile'
      >
        Sign in
      </Link>
