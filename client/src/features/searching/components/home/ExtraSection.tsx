  ...
  return popular && top_rated ? (
    <>
      <div className='relative w-full flex justify-center items-center bg-stone-200 dark:bg-stone-900 py-4 rounded-lg shadow-lg'>
        <div className='w-full flex flex-col relative font-poppins text-xl font-black tracking-[0.3rem] text-stone-500 dark:text-yellow-400 items-center'>
      ...
      <div className='relative w-full flex justify-center items-center bg-stone-200 dark:bg-stone-900 py-4 rounded-lg shadow-lg '>
        <div className='w-full flex flex-col font-poppins text-xl font-black tracking-[0.3rem] text-stone-500 dark:text-yellow-400 items-center'>
