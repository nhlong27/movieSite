...
const SearchResult = () => {
  ...
  return (itemList ?? []).length > 0 ? (
    ...
    <div className='bg-stone-200 rounded-b-xl shadow-xl px-4 py-2 h-[5rem] md:h-[3rem] grid place-items-center font-poppins text-xl text-red-800 font-bold'>No Movie or TV Show exists with that name</div>
  );
};
const SuspenseState = () => {
  return (
