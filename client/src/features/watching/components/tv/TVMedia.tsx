...
const TVMedia = () => {
  ...
  return isMd ? (
    ...
    px-custom-x-max-medium flex flex-col bg-stone-200 rounded-xl shadow-xl items-center justify-start font-poppins'
        >
          <Trailers />
        </div>
      </div>
      ...
      >
        ...
        {isMediaWindowDisplay ? (
          <div
            ref={reactPlayerRef}
            className={`w-11/12 p-2 bg-stone-200 rounded-xl shadow-xl pb-6`}
          >
      ...
      <div className='w-full md:w-3/4 xl:w-1/2 bg-stone-300 grid place-items-center font-poppins py-4'>
      ...
      <div ref={seasonsAndEpisodesRef} className='relative w-full py-4 px-4 bg-stone-300'>
        <SeasonsAndEpisodes
          options={{
            ref: reactPlayerRef,
          }}
      ...
      >
        ...
        {extraData.similar?.results?.length ?? 0 > 0 ? (
          ...
          <div className='relative w-full flex md:flex-row flex-col h-[4rem] justify-center items-baseline gap-4 bg-stone-300 shadow-inner border-2 border-stone-400 font-poppins text-normal font-bold px-8 py-8'>
            <h1 className='text-stone-400 text-sm'>No movies or TV shows for this media</h1>
            <Link
              className='text-stone-600 hover:text-stone-800 hover:underline flex items-start justify-center relative'
              to='/discover'
