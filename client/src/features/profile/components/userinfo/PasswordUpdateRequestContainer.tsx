    ...
    <div className='w-11/12 py-2'>
      <FormComponent
        styles={{
          ...
          button:
            'ml-auto py-3 mt-2 text-sm rounded-lg bg-stone-300 ring-2 ring-stone-400 text-stone-500 hover:bg-stone-400 dark:bg-stone-900 dark:ring-transparent shadow-lg dark:text-amber-400 px-4 font-bold dark:hover:text-stone-900 dark:hover:bg-amber-300 dark:hover:ring-stone-800',
          inputName:
