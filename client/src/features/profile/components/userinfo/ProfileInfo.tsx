...
const ProfileInfo = () => {
  ...
  return (
    <div className='w-11/12 py-2'>
      <FormComponent
        styles={{
          form: 'bg-stone-200 gap-2 flex flex-col dark:bg-yellow-500',
          input: 'bg-stone-300 rounded-md py-[3px] pl-2 text-stone-400 dark:bg-amber-300 dark:text-stone-900 shadow-inner',
          button:
            'ml-auto py-2  rounded-lg mt-4 bg-stone-300 ring-2 ring-stone-400 text-stone-500 text-base hover:bg-stone-400 dark:bg-stone-900 dark:ring-transparent shadow-lg dark:text-amber-400 px-4 font-bold dark:hover:text-stone-900 dark:hover:bg-amber-300 dark:hover:ring-stone-800',
          inputName:
