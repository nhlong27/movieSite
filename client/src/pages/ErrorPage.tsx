    ...
    <>
      {isMd ? (
        <div className=' min-h-screen grid place-items-center w-full bg-stone-900'>
          <div className=' rounded-xl shadow-xl w-1/2 aspect-square flex flex-col justify-center items-center  bg-yellow-500 '>
            <div className='text-[150px] font-semibold leading-none grid place-items-center text-stone-900'>
              404
            </div>
            <div className='mt-6  text-2xl text-center text-stone-900'>
